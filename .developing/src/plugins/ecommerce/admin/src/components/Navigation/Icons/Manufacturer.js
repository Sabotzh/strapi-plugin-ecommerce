...
const Manufacturer = () => (
  <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiBox-root css-uqopch" focusable="false" aria-hidden="true"
       viewBox="0 0 22 22" data-testid="PrecisionManufacturingIcon">
    <path
